...
BasicDialog-Linux-Debug:
	 $(PROJECTBUILD) BasicDialog Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BasicDialog-Linux-DebugGame:
	 $(PROJECTBUILD) BasicDialog Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BasicDialog-Linux-Shipping:
	 $(PROJECTBUILD) BasicDialog Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BasicDialog-Linux-Test:
	 $(PROJECTBUILD) BasicDialog Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BasicDialog:
	 $(PROJECTBUILD) BasicDialog Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)

BasicDialogEditor-Linux-Debug:
	 $(PROJECTBUILD) BasicDialogEditor Linux Debug  -project="$(GAMEPROJECTFILE)" $(ARGS)

BasicDialogEditor-Linux-DebugGame:
	 $(PROJECTBUILD) BasicDialogEditor Linux DebugGame  -project="$(GAMEPROJECTFILE)" $(ARGS)

BasicDialogEditor-Linux-Shipping:
	 $(PROJECTBUILD) BasicDialogEditor Linux Shipping  -project="$(GAMEPROJECTFILE)" $(ARGS)

BasicDialogEditor-Linux-Test:
	 $(PROJECTBUILD) BasicDialogEditor Linux Test  -project="$(GAMEPROJECTFILE)" $(ARGS)

BasicDialogEditor:
	 $(PROJECTBUILD) BasicDialogEditor Linux Development  -project="$(GAMEPROJECTFILE)" $(ARGS)
