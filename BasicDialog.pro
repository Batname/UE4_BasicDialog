...
BasicDialogRootPath=/media/bat/SecondSSD/Projects/Unreal/BasicDialog

gameProjectFile=/media/bat/SecondSSD/Projects/Unreal/BasicDialog/BasicDialog.uproject
build=mono $$unrealRootPath/Engine/Binaries/DotNET/UnrealBuildTool.exe

args=$(ARGS)

include(BasicDialogSource.pri)
include(BasicDialogHeader.pri)
include(BasicDialogConfig.pri)
include(BasicDialogIncludes.pri)
include(BasicDialogDefines.pri)
...
BasicDialog-Linux-Debug.commands = $$build BasicDialog Linux Debug  -project="\"$$gameProjectFile\"" $$args
BasicDialog-Linux-DebugGame.commands = $$build BasicDialog Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BasicDialog-Linux-Shipping.commands = $$build BasicDialog Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BasicDialog-Linux-Test.commands = $$build BasicDialog Linux Test  -project="\"$$gameProjectFile\"" $$args
BasicDialog.commands = $$build BasicDialog Linux Development  -project="\"$$gameProjectFile\"" $$args

BasicDialogEditor-Linux-Debug.commands = $$build BasicDialogEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
BasicDialogEditor-Linux-DebugGame.commands = $$build BasicDialogEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
BasicDialogEditor-Linux-Shipping.commands = $$build BasicDialogEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
BasicDialogEditor-Linux-Test.commands = $$build BasicDialogEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
BasicDialogEditor.commands = $$build BasicDialogEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	...
	BasicDialog-Linux-Debug \
	BasicDialog-Linux-DebugGame \
	BasicDialog-Linux-Shipping \
	BasicDialog-Linux-Test \
	BasicDialog \
	BasicDialogEditor-Linux-Debug \
	BasicDialogEditor-Linux-DebugGame \
	BasicDialogEditor-Linux-Shipping \
	BasicDialogEditor-Linux-Test \
	BasicDialogEditor \
